    ...
    ##################################
             ...
             column(12,
                    ...
                    div(id = "boton_registrar",
                        ...
                        actionButton("submit", "Registrar", class = "btn-success", icon = icon("user-plus"))),
                    div(style="display: inline-block;vertical-align: top;padding: 10px; padding-left: 10px;",
                  ...
                  column(6,
                    ...
                    # Form parte 1.1
                      div(
                        ...
                        radioButtons("finan_calculo", "CÃ¡lculo", 
              ...
              # Form parte 1.2
                    column(5,
                      div(
                        ...
                        selectInput("finan_tipo", "Tipo de financiación", c("", "Crédito", "OpciÃ³n 2", "Opción 3")),
                        selectInput("finan_credito_tipo", "Tipo de crédito", c("", "Fideicomiso", "OpciÃ³n 2",
                                                                               "Opcion 3")),
                        selectInput("finan_inversion_tipo", "Tipo de inversión", c("", "Comercial", "OpciÃ³n 2",
                                                                                   "Opción 3")),
             ...
             column(6,
                    ...
                    column(6,
                           div(
                             ...
                             radioButtons("identificacion_tipo", labelMandatory("Tipo de identificaciÃ³n"),
                                          c("CÃ©dula", "Pasaporte", "OpciÃ³n 3"), inline = TRUE),
                             ...
                             selectInput("cliente_vivienda", "Tipo de vivienda",
                                         c("",  "Propietario", "Arrendamiento", "OpciÃ³n 3")),
            ...
            # Formulario de direcciÃ³n
             div(style="padding-left: 10px;",
                ...
                div(style="display: inline-block;vertical-align: top;padding-left: 25px;",
                    selectInput("direccion_provincia", "Provincia", sort(c("", "PanamÃ¡", "PanamÃ¡ Oeste", "ChiriquÃ­",
                                                                      "Los Santos", "CoclÃ©", "ColÃ³n", "Veraguas", "DarÃ­en",
                                                                      "Guna Yala", "Herrera", "Bocas del Toro"))),
                    selectInput("direccion_distrito", "Distrito",
                                c("",  "OpciÃ³n 1", "OpciÃ³n 2", "OpciÃ³n 3")),
                ...
                div(style="display: inline-block;vertical-align: top;padding-left: 75px;",
                    ...
                    textInput("direccion_tel", "TelÃ©fono residencial", "")
                    ),
                div(style="display: inline-block;vertical-align: top;padding-left: 75px;",
                    textInput("direccion_tel_trab", "TelÃ©fono trabajo",""),
                    textInput("direccion_cel", "Celular", ""),
                    textInput("direccion_correo", "Correo electrÃ³nico", "")
                    )
                ),
            
            # Formulario de informaciÃ³n de ingresos del cliente
            div(
                id = "form7",
                h3("InformaciÃ³n Laboral y de Ingresos"),
                div(style="display: inline-block;vertical-align: top;padding-left: 25px;",
                ...
                div(style="display: inline-block;vertical-align: top;padding-left: 75px;",
                    ...
                    selectInput("laboral_ingresos_tipo", "Tipo de ingresos", c("", "Estados Financieros", "OpciÃ³n 2",
                                                                               "OpciÃ³n 3")),
                    selectInput("laboral_ingresos_otros_tipo", "Tipo de otros ingresos", c("", "Estados Financieros", "OpciÃ³n 2",
                                                                               "OpciÃ³n 3")),
                    br(),
                    br(),
                ...
                div(style="display: inline-block;vertical-align: top;padding-left: 75px;",
                    textInput("laboral_profesion", "ProfesiÃ³n", ""),
                    selectInput("laboral_situacion", "SituaciÃ³n laboral", c("", "Independiente no profesional", "OpciÃ³n 2",
                                                                                           "OpciÃ³n 3")),
                    selectInput("laboral_actividad", "Actividad", c("", "Personal - Particular", "OpciÃ³n 2",
                                                                                           "OpciÃ³n 3"))
                )
            ),
            ...
            div(
              conditionalPanel("input.cliente_estado_civil == 'Casado'", 
                               ...
                               column(3,
                                      ...
                                      textInput("conyugue_profesion", "ProfesiÃ³n", ""),
             ...
             shinyjs::hidden(
               div(
                 id = "thankyou_msg",
                 h3("El financiamiento ha sido registrado con éxito!"),
              ...
              shinyjs::hidden(
                div(
                  id = "modificar_msg",
                  h3("Se modificÃ³ el financiamiento exitosamente!"),
  ...
  server = function(input, output, session) {
    ...
    output$sesionVerificada <- renderUI({
      ...
      div( 
          ...
          h5(paste("Sesión activa: ", usernames_ID[input$shinyalert]))
      )
    })
